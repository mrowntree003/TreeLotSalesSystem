...
//==============================================================================
public class SelectScoutsView extends View
{
...
//    protected Button submitButton;
    ...
    //--------------------------------------------------------------------------
    public SelectScoutsView(IModel sc)
    {
        super(sc, "SelectScoutsView");
    ...
    private VBox createFormContent()
    {
        ...
        selectButton = new Button("Select Scout");
        ...
        selectButton.setOnAction(e -> {
            try {
                ...
                shift.updateState("ScoutID", selectedScout.getState("ID"));
                shift.updateState("SessionID", myModel.getState("ID"));
                shift.updateState("StartTime", myModel.getState("StartTime"));

                shift.createAndShowCompanionView();
        ...
        btnContainer.getChildren().addAll(selectButton, cancelButton);
