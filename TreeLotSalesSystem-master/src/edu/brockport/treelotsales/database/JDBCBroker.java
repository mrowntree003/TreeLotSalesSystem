...
// specify the package
package edu.brockport.treelotsales.database;
...
// project imports
import edu.brockport.treelotsales.common.PropertyFile;
...
public class JDBCBroker
{
	...
	protected JDBCBroker()
		...
		props = new PropertyFile("src/edu/brockport/treelotsales/dbConfig.ini");
		if (props != null)
		{
